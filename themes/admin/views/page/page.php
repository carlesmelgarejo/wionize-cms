									...
									<dl>
										<dt>
											<?php
												...
												$label_title = $extend_field['name'] . ( !empty($extend_field['description']) ? ' : ' .$extend_field['description'] : '');
											?>
											<?php if ($extend_field['type'] != '3' && $extend_field['name'] != 'content') :?>
...
<script type="text/javascript">
    ...
    ION.initTinyEditors(null, '#pageExtendFields .smallTinyTextarea', 'extended', {'height':80});

    ION.initTinyEditors('.tab_page', '#pageTabContent .tinyTextarea');
    ION.initTinyEditors('.tab_page', '#pageTabContent .smallTinyTextarea', 'extended', {'height':80});

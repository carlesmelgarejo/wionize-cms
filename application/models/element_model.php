...
class Element_model extends Base_model
{
	 ...
	 * @return mixed
	 */
	public function get_fields_from_parent($parent, $id_parent, $lang, $id_definition = FALSE, $order = FALSE, $id_element = FALSE)
	{
		// Loads the element model if it isn't loaded
		$CI =& get_instance();
		...
		// Get Elements
		$cond = array('order_by' => 'element.ordering '.$ordering );

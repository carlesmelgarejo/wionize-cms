WIonize CMS
=======================
CMC based on Ionize 1.0.2, multilingual PHP CMS (description below).
This version has catalan, spanish and english languages preinstalled and some minor modifications.
